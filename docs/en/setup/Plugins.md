...
| :--- | :--- | :--- |
| [aiohttp](https://docs.aiohttp.org/en/stable/) | Python >=3.6 - ['3.7.4'];  | `sw_aiohttp` |
| [celery](https://docs.aiohttp.org/en/stable/) | Python >=3.6 - ['4.2.1'];  | `sw_celery` |
| [django](https://www.djangoproject.com/) | Python >=3.6 - ['3.2'];  | `sw_django` |
| [elasticsearch](https://github.com/elastic/elasticsearch-py) | Python >=3.6 - ['7.13.0', '7.14.0', '7.15.0'];  | `sw_elasticsearch` |
